...
#pragma region setup objs
  ...
  auto s_unlit = std::make_shared<xac::Shader>(
      "../20-interface-block/shader/common.vert.glsl", "../20-interface-block/shader/unlit.frag.glsl"
  );
  auto s_lit = std::make_shared<xac::Shader>(
      "../20-interface-block/shader/common.vert.glsl", "../20-interface-block/shader/lit.frag.glsl"
  );
