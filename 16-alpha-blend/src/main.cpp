...
#pragma region setup objs
  ...
  auto light_shader = std::make_shared<xac::Shader>("../16-alpha-blend/shader/light_vert.glsl",
                                                    "../16-alpha-blend/shader/light_frag.glsl");
  auto obj_shader =
      std::make_shared<xac::Shader>("../16-alpha-blend/shader/obj_vert.glsl", "../16-alpha-blend/shader/obj_frag.glsl");
