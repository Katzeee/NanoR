...
#pragma region setup objs
  ...
  auto s_unlit = std::make_shared<xac::Shader>("../17-face-culling/shader/common_vert.glsl",
                                               "../17-face-culling/shader/unlit_frag.glsl");
  auto s_lit = std::make_shared<xac::Shader>("../17-face-culling/shader/common_vert.glsl",
...
#pragma region common settings for obj shader
    ...
    s_lit->SetVec3("ws_cam_pos", global_context.camera_->GetPosition());
#pragma endregion
