...
auto main() -> int {
  ...
  // setup shader
  xac::Shader light_shader("../08-lighting-map/shader/light-vert.vs", "../08-lighting-map/shader/light-frag.fs");
  xac::Shader obj_shader("../08-lighting-map/shader/vert.vs", "../08-lighting-map/shader/frag.fs");
